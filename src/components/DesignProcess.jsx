    ...
    <section className="px-6 md:px-12 lg:px-20 py-20 text-black">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative flex flex-col md:flex-row items-center md:justify-between gap-12">
          ...
          <div className="hidden md:block absolute top-20 left-0 right-0 h-[2px] bg-[#a57151] z-0 mx-20" />

          {steps.map((step) => (
            <div key={step.id} className="flex flex-col items-center text-center relative z-10">
              <div className="relative">
                <div className="bg-[#a57151] text-white rounded-full w-40 h-40 flex items-center justify-center">
                  {step.icon}
                </div>
